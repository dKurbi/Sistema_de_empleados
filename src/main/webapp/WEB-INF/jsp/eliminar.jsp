...
<div class="container">
    ...
    <form action="${urlEditar}" modelAttribute="empleadoForma" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombreEmpleado" name="nombreEmpleado" required="true" value="${empleado.nombreEmpleado}" aria-describedby="nameHelp">
            <div id="nameHelp" class="form-text">Ingrese el nombre del empleado.</div>
        </div>
        <div class="mb-3">
