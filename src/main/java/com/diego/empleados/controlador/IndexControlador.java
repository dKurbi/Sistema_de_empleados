package com.diego.empleados.controlador;

import com.diego.empleados.modelo.Empleado;
import com.diego.empleados.servicio.EmpleadoServicio;
...
public class IndexControlador {
    ...
    public String iniciar(ModelMap modelo) {
        ...
        return "index"; // Esto devolverá "index.jsp" si tienes configurado el prefijo y sufijo correctamente
    }
